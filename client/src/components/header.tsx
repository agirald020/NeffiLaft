        ...
        <div className="flex justify-between items-center h-20">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex-shrink-0">
              ...
              <p className="text-sm text-blue-100 font-medium">Sistema de Gestión Fiduciaria</p>
            </div>
          </div>
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="flex items-center space-x-3 text-white hover:bg-white/20 transition-all duration-300 rounded-xl px-4 py-2 backdrop-blur-sm border border-white/20" data-testid="button-user-menu">
                  <div className="w-10 h-10 bg-gradient-to-br from-white to-blue-50 rounded-full flex items-center justify-center shadow-lg ring-2 ring-white/30">
                    <User className="text-blue-600 text-lg" />
                  </div>
